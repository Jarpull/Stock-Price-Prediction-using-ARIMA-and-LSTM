# -*- coding: utf-8 -*-
"""
Created on Sat May 21 17:04:26 2022
...
np.savetxt("ScaledDataADRO15064.csv", file, '%s', delimiter=",")
...
np.savetxt("PredictionsADRO15064.csv", file, '%s', delimiter=",")
...
np.savetxt("ValidationADRO15064.csv", file, '%s', delimiter=",")
