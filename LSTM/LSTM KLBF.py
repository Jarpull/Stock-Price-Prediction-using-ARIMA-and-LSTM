# -*- coding: utf-8 -*-
"""
Created on Sat May 21 17:04:22 2022
...
np.savetxt("ScaledDataKLBF20064.csv", file, '%s', delimiter=",")
...
np.savetxt("PredictionsKLBF20064.csv", file, '%s', delimiter=",")
...
np.savetxt("ValidationKLBF20064.csv", file, '%s', delimiter=",")
