# -*- coding: utf-8 -*-
"""
Created on Sat May 21 17:04:17 2022
...
df = pd.read_csv('C:/Users/Jarpul/Downloads/ICBP.JK.csv',
                parse_dates=['Date'])
np.savetxt("dfICBP.csv", df, '%s')
...
test_data
np.savetxt("testdataICBP.csv", test_data, '%s')
...
print(fc)
np.savetxt("ForecastedICBP.csv", fc, '%.4f')
...
plt.fill_between(lower_series.index, lower_series, upper_series, 
                 color='k', alpha=.10)
plt.title('Prediksi Harga Saham ICBP')
plt.xlabel('Time')
plt.ylabel('Harga Saham ICBP')
