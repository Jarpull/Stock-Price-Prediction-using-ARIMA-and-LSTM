# -*- coding: utf-8 -*-
"""
Created on Sat May 21 17:04:14 2022
...
df = pd.read_csv('C:/Users/Jarpul/Downloads/KLBF.JK.csv',
                parse_dates=['Date'])
...
test_data
np.savetxt("testdataKLBF.csv", test_data, '%s')
...
print(fc)
np.savetxt("ForecastedKLBF.csv", fc, '%.4f')
...
plt.fill_between(lower_series.index, lower_series, upper_series, 
                 color='k', alpha=.10)
plt.title('Prediksi Harga Saham KLBF')
plt.xlabel('Time')
plt.ylabel('Harga Saham KLBF')
